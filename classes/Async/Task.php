...
class Task implements TaskInterface
{
     ...
     * @return Task
     */
    public static function createGet($url, $params = null, $timeout = 90, $transfer_timeout = 600)
    {
     ...
     * @return Task
     */
    public static function createPost($url, $params = null, $timeout = 90, $transfer_timeout = 600)
    {
